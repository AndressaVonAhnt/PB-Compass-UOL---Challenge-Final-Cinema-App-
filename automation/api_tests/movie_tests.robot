...
CT-MOVIE-019 - Buscar Filme Inexistente por ID
...
CT-MOVIE-031 - Buscar Filme Existente por ID
    ...
    # Primeiro busca a lista de filmes para obter um ID válido
    ...
    # Busca o filme específico por ID
...
CT-MOVIE-053 - Tentar Criar Filme como Usuário Comum
