# Suíte de testes de Autenticação API
*** Settings ***
...
*** Test Cases ***
CT-AUTH-001 - Login Bem-Sucedido com Credenciais Válidas
...
CT-AUTH-002 - Tentativa de Registro com Email Duplicado
...
CT-AUTH-003 - Tentativa de Registro com Email Inválido
...
CT-AUTH-041 - Registro de Novo Usuário
...
CT-AUTH-010 - Acesso ao Perfil Sem Token
...
CT-AUTH-016 - Tentativa de Alterar Role via PUT /auth/profile
