# Suíte de testes de Reservations API
*** Settings ***
...
*** Test Cases ***
CT-RESERVE-043 - Criação Direta de Reserva
...
CT-RESERVE-044 - Tentar Criar Reserva com Assento Ocupado
    ...
    # Tentar criar reserva com assento A1 que já está ocupado
    @{seats}=    Create List
...
CT-RESERVE-045 - Tentar Criar Reserva sem Autenticação
